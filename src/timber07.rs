...
fn updateBranches(seed :i32, branchPositions :&mut[i32; NUM_BRANCHES]) {
	// Move all the branches down one place
	
    //Cpp for (int j = NUM_BRANCHES - 1; j > 0; j--) {
	//Cpp 	branchPositions[j] = branchPositions[j - 1];
	//Cpp }
...
*/
    ...
    //let mut branches = [Sprite::new(); NUM_BRANCHES] ;
    let mut branches :[Sprite; NUM_BRANCHES] = [Sprite::default(), Sprite::default(), 
                                                Sprite::default(), Sprite::default(), 
                                                Sprite::default(), Sprite::default() 
                                               ];
    
    //let mut branchPositions = [Side::NONE, Side::NONE, Side::NONE, Side::NONE, Side::NONE, Side::NONE];
    let mut branchPositions :[i32; NUM_BRANCHES] = [2; NUM_BRANCHES];
